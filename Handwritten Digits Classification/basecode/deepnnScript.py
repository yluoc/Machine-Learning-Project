...
def create_multilayer_perceptron():
    ...
    class net(nn.Module):
        def __init__(self):
            ...
            n_hidden_3 = 256  # 3st layer number of features
            n_hidden_4 = 256  # 4st layer number of features
            n_hidden_5 = 256  # 5st layer number of features
            n_hidden_6 = 256  # 6st layer number of features
            n_hidden_7 = 256  # 7st layer number of features
...
print("Time costed by DeepNN", time.time() - now, "seconds")
